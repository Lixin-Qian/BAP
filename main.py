...
if __name__ == '__main__':
    ...
    flags.DEFINE_string('attack', 'fgsm', 'Which method to attack model')
    flags.DEFINE_string('adv_train', 'fgsm', 'Adversarial training')
...
if __name__ == '__main__':
    ...
    tf.app.run()
>>>>>>> 5952b40853b4ca9143ae5469167c8065a5523a59:main.py
